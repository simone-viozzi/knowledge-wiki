...
if __name__ == "__main__":
    # the classes Employee and NormalEmployee are identical
    # except for the use of the dataclass decorator
    # the dataclass decorator adds the __init__ method
    # and the __repr__ method using the fields defined
    # in the class
    
    # the dataclass decorator is useful for creating
    # simple data classes or when the init method is
    # just a simple assignment of values to attributes

    coder = Employee("Joe", "Blow", 5, 8, 18.0)
    print(coder.weekly_pay)

    coder2 = NormalEmployee("Joe", "Blow", 5, 8, 18.0)
